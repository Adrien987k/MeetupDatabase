...
\copy Group(group_id,category_id,city_id,created,description,photo.base_url,photo.highres_link,photo.photo_link,photo.thumb_link,photo.type,join_mode,group_name,organizer_id,visibility,who)
