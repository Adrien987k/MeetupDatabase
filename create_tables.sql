...
CREATE TYPE ACCEPTS_TYPE AS ENUM ('cash', 'paypal', 'wepal', 'amazon', 'others', 'wepay');
CREATE TYPE USER_STATUS_TYPE AS ENUM ('active','prereg');
...
CREATE TABLE Event(
       ...
       fee_accepts ACCEPTS_TYPE NOT NULL,
       fee_amount REAL,
